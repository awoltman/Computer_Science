...
public static void main( String [] args)throws IOException
	{
		...
		int [] selections = new int[sizeOfSelections];
			...
			int [] NumberOfEmployees = new int [100];
			woltmanandrewEmployee [] employees = new woltmanandrewEmployee [150];	
	...
	public static void salaryReport(woltmanandrewEmployee [] emppass,int [] NumberOfEmployees)
	{
		...
		for(int i = 0;i < NumberOfEmployees[3];i++){
			if(emppass[i].getLastName().equals(LastName)){//if what they type in matches a persons last name then if displays their name and salary
		...
		if(!(emppass[l].getLastName().equals(LastName))){
	...
	public static void divisionReport(woltmanandrewEmployee [] emppass,int [] NumberOfEmployees)
	{
		...
		division = true;
			...
			int beginOfManagement = 14;
			int endOfManagement = 23;
			for(int i = NumberOfEmployees[0];i<NumberOfEmployees[1]+NumberOfEmployees[0];i++){
			...
			for(int i = NumberOfEmployees[0];i<(NumberOfEmployees[1]+NumberOfEmployees[0]);i++){//gets a total of all the employees that are in temporary
		if(emppass[i].getDivision().equals("Management") && emppass[i].getStatus().equals("a")){
		...
		division = true;
			...
			int beginOfTemporary = 23;
			int endOfTemporary = 26;
			for(int i = (NumberOfEmployees[0]+NumberOfEmployees[1]);i<NumberOfEmployees[3];i++){
			...
			for(int i = (NumberOfEmployees[0]+NumberOfEmployees[1]);i < NumberOfEmployees[3];i++){//gets a total of all the employees that are in temporary
				if(emppass[i].getDivision().equals("Temporary") && emppass[i].getStatus().equals("a")){
