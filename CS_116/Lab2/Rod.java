...
public class Rod
{
	...
	{
		String str = "The category is:"+" "+materialBase+" "+"The name of the material is:"+" "+material+" "+"The length is:"+" "+length+" "+"The cross area is:"+" "+area+" "+"The object id is:"+" "+currentid+" "+"The temperature is:"+" "+temp;
		return str;
	}
