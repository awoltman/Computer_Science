	...
	public ArrayList<Worker>  listOfWorkers()
	{
		...
		try
		{
			...
			while(scan1.hasNextLine())
			{
				...
				else if(work.equals("ADMINISTRATIVE_MANAGER"))
				{
					j = Jobs.ADMINISTRATIVE_MANAGER;
				}
				...
				double hours = 0;
				if(j.equals(Jobs.ENGINEERING_MANAGER) || j.equals(Jobs.ADMINISTRATIVE_MANAGER) || j.equals(Jobs.ADMINISTRATIVE_SECRETARY) || j.equals(Jobs.ADMINISTRATIVE_ASSISTANT))
				{
				...
				else if(j.equals(Jobs.ENGINEERING_MANAGER) || j.equals(Jobs.ADMINISTRATIVE_MANAGER))
				{
